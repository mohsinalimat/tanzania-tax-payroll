...
def create_salary_components(company_name, company_abbr):
	...
	salary_components = [
		...
		# Other deductions
		{
			...
			"is_tax_applicable": 0,
			"depends_on_payment_days": 0,
			"condition": "heslb != '' and heslb is not None",
			"formula": "(base+IA_1)*0.15",
			"amount_based_on_formula": 1,
			"accounts": [
				{
...
def create_default_salary_structure(company_name, company_abbr):
	...
	earnings = [
		...
		{"salary_component": "NSSF Expense", "abbr": "NSSFe", "formula": "(base+IA_1)*0.1", "amount_based_on_formula": 1, "do_not_include_in_total": 1, "condition": "pension_fund == 'NSSF'"},
		{"salary_component": "PSSF Expense", "abbr": "PSSFe", "formula": "(base+IA_1)*0.15", "amount_based_on_formula": 1, "do_not_include_in_total": 1, "condition": "pension_fund == 'PSSF'"},
	...
	deductions = [
		{"salary_component": "NSSF", "abbr": "NSSFemp", "formula": "(base+IA_1)*0.1", "amount_based_on_formula": 1, "condition": "pension_fund == 'NSSF'"},
		{"salary_component": "NSSF Employer", "abbr": "NSSFempl", "formula": "(base+IA_1)*0.1", "amount_based_on_formula": 1, "do_not_include_in_total": 1, "condition": "pension_fund == 'NSSF'"},
		{"salary_component": "PSSF", "abbr": "PSSFemp", "formula": "(base+IA_1)*0.05", "amount_based_on_formula": 1, "condition": "pension_fund == 'PSSF'"},
		{"salary_component": "PSSF Employer", "abbr": "PSSFempl", "formula": "(base+IA_1)*0.15", "amount_based_on_formula": 1, "do_not_include_in_total": 1, "condition": "pension_fund == 'PSSF'"},
		...
		# Other deductions
		{"salary_component": "HESLB", "abbr": "HESLB", "formula": "(base+IA_1) * 0.15", "amount_based_on_formula": 1, "condition": "heslb and heslb != ''"},
